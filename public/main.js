...
var $author$project$Model$Init = {$: 'Init'};
var $author$project$Model$Pushups = {$: 'Pushups'};
var $author$project$Model$initialModel = {exercise: $author$project$Model$Pushups, finishedRounds: 0, remainingRest: 0, status: $author$project$Model$Init, totalTime: 0};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2($author$project$Model$initialModel, $elm$core$Platform$Cmd$none);
};
var $author$project$Update$KeyDown = function (a) {
	return {$: 'KeyDown', a: a};
};
...
var $author$project$Update$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$ohanhi$keyboard$Keyboard$downs($author$project$Update$KeyDown),
				A2($elm$time$Time$every, 1000, $author$project$Update$Tick)
			]));
};
var $author$project$Model$Doing = {$: 'Doing'};
var $author$project$Model$Finished = {$: 'Finished'};
var $author$project$Model$Resting = {$: 'Resting'};
var $author$project$Model$getMaxRepsPerRound = function (model) {
...
var $author$project$Model$getRepsOfRound = F2(
	function (model, finishedRounds) {
		var maxReps = $author$project$Model$getMaxRepsPerRound(model);
		return (_Utils_cmp(finishedRounds, maxReps) < 1) ? finishedRounds : ((2 * maxReps) - finishedRounds);
	});
...
var $author$project$Model$getRestAfterRound = F2(
	function (model, finishedRounds) {
		var nextRound = finishedRounds + 1;
		var repsNextRound = A2($author$project$Model$getRepsOfRound, model, nextRound);
		var maxRestAmount = $author$project$Model$maxRest(model.exercise);
		var getRestFunc = function () {
			var _v0 = model.exercise;
			if (_v0.$ === 'Pushups') {
				return $author$project$Model$getRestPushups;
			} else {
				return $author$project$Model$getRestPullups;
			}
		}();
		var restAmount = A2(getRestFunc, model, repsNextRound);
		return A2($elm$core$Basics$min, maxRestAmount, restAmount);
	});
var $author$project$Model$getTotalRounds = function (model) {
	var maxReps = $author$project$Model$getMaxRepsPerRound(model);
	return (2 * maxReps) - 1;
};
var $author$project$Update$advanceRound = function (model) {
	var newFinishedRounds = model.finishedRounds + 1;
	var wasLastRound = _Utils_eq(
		newFinishedRounds,
		$author$project$Model$getTotalRounds(model));
	var newStatus = wasLastRound ? $author$project$Model$Finished : $author$project$Model$Resting;
	var isPushing = _Utils_eq(model.status, $author$project$Model$Doing);
	var newModel = isPushing ? _Utils_update(
		model,
		{
			finishedRounds: newFinishedRounds,
			remainingRest: A2($author$project$Model$getRestAfterRound, model, newFinishedRounds),
			status: newStatus
		}) : model;
	return _Utils_Tuple2(newModel, _List_Nil);
};
...
var $author$project$Model$isInProgress = function (model) {
	return A2(
		$elm$core$List$member,
		model.status,
		_List_fromArray(
			[$author$project$Model$Doing, $author$project$Model$Resting]));
};
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$Ports$sounds = _Platform_outgoingPort('sounds', $elm$json$Json$Encode$string);
var $author$project$Sound$play = function (sound) {
	return $author$project$Ports$sounds('countdown');
};
var $author$project$Update$setExercise = F2(
...
var $author$project$Update$startChallenge = function (model) {
	return _Utils_Tuple2(
		_Utils_update(
			model,
			{status: $author$project$Model$Doing}),
		_List_Nil);
};
var $author$project$Sound$Countdown = {$: 'Countdown'};
var $author$project$Update$tickSecond = function (model) {
	var newRemainingRest = A2($elm$core$Basics$max, 0, model.remainingRest - 1);
	var restIsOver = !newRemainingRest;
	var newStatus = restIsOver ? $author$project$Model$Doing : $author$project$Model$Resting;
	var sounds = (newRemainingRest === 3) ? _List_fromArray(
		[$author$project$Sound$Countdown]) : _List_Nil;
	return _Utils_Tuple2(
		_Utils_update(
			model,
			{remainingRest: newRemainingRest, status: newStatus, totalTime: model.totalTime + 1}),
		sounds);
};
	...
	function (msg, model) {
		var _v0 = function () {
			switch (msg.$) {
				case 'SetExercise':
					var exercise = msg.a;
					return A2($author$project$Update$setExercise, exercise, model);
				case 'Tick':
					return $author$project$Model$isInProgress(model) ? $author$project$Update$tickSecond(model) : _Utils_Tuple2(model, _List_Nil);
				case 'StartChallenge':
					return $author$project$Update$startChallenge(model);
				case 'RoundDone':
					return $author$project$Update$advanceRound(model);
				default:
					return $author$project$Update$advanceRound(model);
			}
		}();
		...
		return _Utils_Tuple2(
			...
			$elm$core$Platform$Cmd$batch(
				A2($elm$core$List$map, $author$project$Sound$play, sounds)));
	});
...
var $author$project$Model$getGameText = function (model) {
	var _v0 = model.status;
	switch (_v0.$) {
		case 'Init':
			return 'The Pyramid Challenge';
		case 'Doing':
			var _v1 = model.exercise;
			if (_v1.$ === 'Pushups') {
...
var $author$project$View$makeDefaultRow = F2(
	function (elements, rowAttributes) {
		return A2(
			$rundis$elm_bootstrap$Bootstrap$Grid$row,
			_List_fromArray(
				[
					$rundis$elm_bootstrap$Bootstrap$Grid$Row$centerXs,
					$rundis$elm_bootstrap$Bootstrap$Grid$Row$attrs(rowAttributes)
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$View$gameTextRow = function (model) {
	return A2(
		$author$project$View$makeDefaultRow,
		_List_fromArray(
			[
				A2(
				$elm$html$Html$h3,
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Model$getGameText(model))
					]))
			]),
		_List_fromArray(
			[$rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$p1, $rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$pt5, $rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$mt5]));
};
var $author$project$Model$Pullups = {$: 'Pullups'};
var $author$project$Update$SetExercise = function (a) {
	return {$: 'SetExercise', a: a};
};
...
var $author$project$View$exerciseRadioButtons = A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Update$SetExercise($author$project$Model$Pushups)),
				...
				_List_fromArray(
					[
						$rundis$elm_bootstrap$Bootstrap$Form$Radio$inline,
						$rundis$elm_bootstrap$Bootstrap$Form$Radio$onClick(
						$author$project$Update$SetExercise($author$project$Model$Pullups))
					]),
				'Pullups')
			])));
...
var $author$project$Update$StartChallenge = {$: 'StartChallenge'};
...
var $author$project$View$makeSubmitButton = F2(
	function (msg, text) {
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[$rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$ml2, $rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$mr2]))
				]),
			_List_fromArray(
				[
...
var $author$project$View$startGameButton = A2($author$project$View$makeSubmitButton, $author$project$Update$StartChallenge, 'Let\'s go!');
var $author$project$View$inputFormRow = A2(
	$author$project$View$makeDefaultRow,
	_List_fromArray(
		[
			A2(
			...
			_List_Nil,
			_List_fromArray(
				[$author$project$View$exerciseRadioButtons, $author$project$View$startGameButton]))
		]),
	_List_fromArray(
...
var $author$project$View$nextRepsRow = function (model) {
	var message = $elm$core$String$concat(
		_List_fromArray(
			[
				$elm$core$String$fromInt(
				A2($author$project$Model$getRepsOfRound, model, model.finishedRounds + 1))
			]));
	return A2(
		$author$project$View$makeDefaultRow,
		_List_fromArray(
			[
				$elm$html$Html$text('Now do'),
				A2(
				$elm$html$Html$h1,
				_List_Nil,
				_List_fromArray(
		...
		_List_fromArray(
			[$rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$pt5, $rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$pb4]));
};
var $author$project$Utilities$sumOf1To = function (n) {
	return ((n * (n + 1)) / 2) | 0;
};
var $author$project$Model$getTotalFinishedReps = function (model) {
	var maxReps = $author$project$Model$getMaxRepsPerRound(model);
	return (2 * $author$project$Utilities$sumOf1To(maxReps)) - maxReps;
};
var $author$project$Model$getTotalReps = function (model) {
	var maxTotalReps = $author$project$Model$getTotalFinishedReps(model);
	var maxRounds = $author$project$Model$getTotalRounds(model);
	var maxReps = $author$project$Model$getMaxRepsPerRound(model);
	return (_Utils_cmp(model.finishedRounds, maxReps) < 1) ? $author$project$Utilities$sumOf1To(model.finishedRounds) : (maxTotalReps - $author$project$Utilities$sumOf1To(maxRounds - model.finishedRounds));
};
...
var $author$project$View$progressRow = function (model) {
	var progressText = $elm$core$String$concat(
		_List_fromArray(
			[
				$elm$core$String$fromInt(
				$author$project$Model$getTotalReps(model)),
				' out of ',
				$elm$core$String$fromInt(
				$author$project$Model$getTotalFinishedReps(model))
			]));
	var maxTotalReps = $author$project$Model$getTotalFinishedReps(model);
	var finishedReps = $author$project$Model$getTotalReps(model);
	var valueAsPercent = (finishedReps / maxTotalReps) * 100;
	var progress = $rundis$elm_bootstrap$Bootstrap$Progress$progress(
		_List_fromArray(
			[
				$rundis$elm_bootstrap$Bootstrap$Progress$success,
				$rundis$elm_bootstrap$Bootstrap$Progress$value(valueAsPercent)
			]));
	return A2(
		$author$project$View$makeDefaultRow,
		_List_fromArray(
			[
				progress,
				$elm$html$Html$text(progressText)
			]),
		_List_fromArray(
			[$rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$p1]));
};
var $elm$html$Html$h2 = _VirtualDom_node('h2');
var $author$project$Utilities$as2DigitString = function (num) {
	var numAsString = $elm$core$String$fromInt(num);
	return ($elm$core$String$length(numAsString) === 1) ? ('0' + numAsString) : numAsString;
};
var $author$project$Utilities$secondsToTime = function (totalSeconds) {
	var remainder = totalSeconds % 3600;
	var seconds = remainder % 60;
	var minutes = (remainder / 60) | 0;
	var hours = (totalSeconds / 3600) | 0;
	var components = (hours > 0) ? _List_fromArray(
		[hours, minutes, seconds]) : _List_fromArray(
		[minutes, seconds]);
	var stringComponents = A2($elm$core$List$map, $author$project$Utilities$as2DigitString, components);
	return A2($elm$core$String$join, ':', stringComponents);
};
var $author$project$View$restRow = function (model) {
	return A2(
		$author$project$View$makeDefaultRow,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Utilities$secondsToTime(model.remainingRest))
					]))
			]),
		_List_fromArray(
			[$rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$pt5, $rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$pb4]));
};
var $author$project$Update$RoundDone = {$: 'RoundDone'};
var $author$project$View$roundDoneButtonRow = function () {
	var button = A2($author$project$View$makeSubmitButton, $author$project$Update$RoundDone, 'Done');
	return A2(
		$author$project$View$makeDefaultRow,
		_List_fromArray(
			[button]),
...
var $rundis$elm_bootstrap$Bootstrap$CDN$stylesheet = A3(
	...
	_List_Nil);
var $author$project$View$totalTimeRow = function (model) {
	var message = $elm$core$String$concat(
		_List_fromArray(
			[
				'Your time: ',
				$author$project$Utilities$secondsToTime(model.totalTime)
			]));
	return A2(
		$author$project$View$makeDefaultRow,
		_List_fromArray(
	...
	var elements = function () {
		...
		switch (_v0.$) {
			case 'Init':
				return _List_fromArray(
					[
						$author$project$View$gameTextRow(model),
						$author$project$View$inputFormRow
					]);
			case 'Doing':
				return _List_fromArray(
					[
						$author$project$View$gameTextRow(model),
						$author$project$View$progressRow(model),
						$author$project$View$nextRepsRow(model),
						$author$project$View$roundDoneButtonRow
					]);
			case 'Resting':
				return _List_fromArray(
					[
						$author$project$View$gameTextRow(model),
						$author$project$View$progressRow(model),
						$author$project$View$restRow(model)
					]);
			default:
				return _List_fromArray(
					[
						$author$project$View$gameTextRow(model),
						$author$project$View$totalTimeRow(model)
					]);
		}
	}();
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($rundis$elm_bootstrap$Bootstrap$Grid$container, _List_Nil, elements)
			]));
};
